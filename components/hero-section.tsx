...
export default function HeroSection({ scrollY }: HeroSectionProps) {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      {/* Parallax circles */}
      <div
        className="absolute top-20 right-10 w-64 h-64 rounded-full border border-red-500/20"
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="px-8 py-4 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-600 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/50">
            Join the Mission
          </button>
          <button className="px-8 py-4 border border-slate-400 text-slate-200 font-semibold rounded-lg hover:bg-slate-800/50 transition-all duration-300">
            Learn More
          </button>
        </div>
      </div>

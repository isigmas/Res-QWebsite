    ...
    <section className="py-20 px-6 bg-slate-900">
      <div className="max-w-6xl mx-auto">
        <div className="mb-16 text-center">
          ...
          <p className="text-xl text-slate-300">Built for the most critical rescue missions</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-8 rounded-xl border border-slate-700 bg-slate-800/50 hover:border-red-500/50 hover:bg-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/10"
            >
